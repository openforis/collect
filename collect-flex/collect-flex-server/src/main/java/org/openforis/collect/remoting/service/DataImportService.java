...
public class DataImportService {
	...
	public DataImportState initProcess(boolean overwriteAll) throws DataImportExeption {
	...
	public DataImportState startImport(String surveyName) throws Exception {
