import {
  UPLOADING_SURVEY_FILE,
  SURVEY_FILE_UPLOADED,
  SURVEY_FILE_UPLOAD_ERROR,
  SURVEY_FILE_IMPORT_STARTED,
  SURVEY_FILE_IMPORT_ERROR,
  SURVEY_FILE_IMPORTED,
  SURVEY_FILE_IMPORT_RESET,
} from './actions'
...
export default function (state = SURVEY_FILE_IMPORT_BASE_STATE, action) {
  switch (action.type) {
