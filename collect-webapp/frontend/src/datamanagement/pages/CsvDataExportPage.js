                                    ...
                                    <div>
                                            ...
                                            <Col md={6}>
                                                <Input type="select" name="headingsSource" id="headingsSourceSelect" style={{ maxWidth: '200px' }} 
                                                    ...
                                                    {Object.keys(headingSources).map(headingSource => 
                                                        <option key={headingSource} value={headingSources[headingSource]}>{L.l(`dataManagement.export.sourceForFileHeadings.${headingSource}`)}</option>
                                                    )}
                                                </Input>
                                            </Col>
                                        </FormGroup>
                                        {
                                            ...
                                            <FormGroup row>
                                                ...
                                                <Col md={6}>
                                                    <SurveyLanguagesSelect survey={survey}
                                                        value={languageCode}
