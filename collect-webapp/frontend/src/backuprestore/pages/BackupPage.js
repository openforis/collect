            ...
            <Container>
                <Form style={{width: '600px'}}>
                    <FormGroup tag="fieldset">
                        ...
                        <Col sm={{offset: 4}}>
                            <Button disabled={latestBackupInfo.date === null} variant="contained" onClick={this.handleDownloadLastBackupButtonClick}>{L.l('backup.lastBackup.download')}</Button>
                        </Col>
                    </FormGroup>    
                </Form>
                <br/> <br/> <br/>
                <Row>
                    <Col sm={{offset: 2}}>
                        <Button variant="contained" color="primary" onClick={this.handleBackupButtonClick}>{L.l('backup.generateNewBackup')}</Button>
                    </Col>
                </Row>
            </Container>
        )
