...
public abstract class NodeChange<T extends Node<?>> {
	...
	public static class EntityAddChange extends EntityChange implements NodeAddChange {
		...
		public void merge(EntityChange newChange) {
			this.setChildrenMinCountValidation(newChange.getChildrenMinCountValidation());
			this.setChildrenMaxCountValidation(newChange.getChildrenMaxCountValidation());
			this.setChildrenRelevance(newChange.getChildrenRelevance());
			this.setChildrenRequireness(newChange.getChildrenRequireness());
		}
