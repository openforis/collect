...
public class OfcRecord extends org.jooq.impl.UpdatableTableImpl<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord> {
	...
	private static final long serialVersionUID = 517229609;
	 ...
	 * </pre></code>
	 */
	public final org.jooq.TableField<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord, java.lang.Integer> ROOT_ENTITY_ID = createField("root_entity_id", org.jooq.impl.SQLDataType.INTEGER, this);
	 ...
	 * </pre></code>
	 */
	public final org.jooq.TableField<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord, java.lang.Integer> SUBMITTED_ID = createField("submitted_id", org.jooq.impl.SQLDataType.INTEGER, this);

	/**
	 * An uncommented item
	 */
	public final org.jooq.TableField<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord, byte[]> DATA = createField("data", org.jooq.impl.SQLDataType.BLOB, this);
	...
	public java.util.List<org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord, ?>>asList(org.openforis.collect.persistence.jooq.Keys.ofc_record__record_root_entity_fkey, org.openforis.collect.persistence.jooq.Keys.ofc_record__ofc_record_created_by_user_fkey, org.openforis.collect.persistence.jooq.Keys.ofc_record__ofc_record_modified_by_user_fkey, org.openforis.collect.persistence.jooq.Keys.ofc_record__ofc_record_locked_by_user_fkey, org.openforis.collect.persistence.jooq.Keys.ofc_record__record_submitted_record_fkey);
	}
