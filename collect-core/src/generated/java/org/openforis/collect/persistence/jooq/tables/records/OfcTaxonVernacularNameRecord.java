...
public class OfcTaxonVernacularNameRecord extends org.jooq.impl.UpdatableRecordImpl<org.openforis.collect.persistence.jooq.tables.records.OfcTaxonVernacularNameRecord> {
	...
	private static final long serialVersionUID = 222057014;
	 ...
	 * <p>
	 * <code><pre>
	 * FOREIGN KEY [collect.ofc_taxon_vernacular_name.taxon_system_id]
	 * REFERENCES ofc_taxon [collect.ofc_taxon.system_id]
	 * </pre></code>
	 */
	public void setTaxonSystemId(java.lang.Integer value) {
		setValue(org.openforis.collect.persistence.jooq.tables.OfcTaxonVernacularName.OFC_TAXON_VERNACULAR_NAME.TAXON_SYSTEM_ID, value);
	}
	 ...
	 * </pre></code>
	 */
	public java.lang.Integer getTaxonSystemId() {
		return getValue(org.openforis.collect.persistence.jooq.tables.OfcTaxonVernacularName.OFC_TAXON_VERNACULAR_NAME.TAXON_SYSTEM_ID);
	}
	...
	public org.openforis.collect.persistence.jooq.tables.records.OfcTaxonRecord fetchOfcTaxon() {
		return create()
			...
			.where(org.openforis.collect.persistence.jooq.tables.OfcTaxon.OFC_TAXON.SYSTEM_ID.equal(getValue(org.openforis.collect.persistence.jooq.tables.OfcTaxonVernacularName.OFC_TAXON_VERNACULAR_NAME.TAXON_SYSTEM_ID)))
			.fetchOne();
	}
