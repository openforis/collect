...
public class OfcDataErrorQuery extends org.jooq.impl.TableImpl<org.openforis.collect.persistence.jooq.tables.records.OfcDataErrorQueryRecord> {
	...
	private static final long serialVersionUID = 821384582;

	/**
	 * The reference instance of <code>collect.ofc_data_error_query</code>
	 */
	...
	/**
	 * The column <code>collect.ofc_data_error_query.uuid</code>.
	 */
	public final org.jooq.TableField<org.openforis.collect.persistence.jooq.tables.records.OfcDataErrorQueryRecord, java.lang.String> UUID = createField("uuid", org.jooq.impl.SQLDataType.VARCHAR.length(50), this, "");
	...
	/**
	 * The column <code>collect.ofc_data_error_query.severity</code>.
	 */
	public final org.jooq.TableField<org.openforis.collect.persistence.jooq.tables.records.OfcDataErrorQueryRecord, java.lang.String> SEVERITY = createField("severity", org.jooq.impl.SQLDataType.CHAR.length(1), this, "");

	/**
	 * The column <code>collect.ofc_data_error_query.query_id</code>.
	 */
	public final org.jooq.TableField<org.openforis.collect.persistence.jooq.tables.records.OfcDataErrorQueryRecord, java.lang.Integer> QUERY_ID = createField("query_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
	...
	/**
	 * The column <code>collect.ofc_data_error_query.modified_date</code>.
	 */
	public final org.jooq.TableField<org.openforis.collect.persistence.jooq.tables.records.OfcDataErrorQueryRecord, java.sql.Timestamp> MODIFIED_DATE = createField("modified_date", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
	...
	public java.util.List<org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.OfcDataErrorQueryRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.OfcDataErrorQueryRecord, ?>>asList(org.openforis.collect.persistence.jooq.Keys.OFC_DATA_ERROR_QUERY__OFC_DATA_ERROR_QUERY_TYPE_FKEY, org.openforis.collect.persistence.jooq.Keys.OFC_DATA_ERROR_QUERY__OFC_DATA_ERROR_QUERY_FKEY);
	}
