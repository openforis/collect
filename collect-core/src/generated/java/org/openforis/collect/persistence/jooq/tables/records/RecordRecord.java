...
public class RecordRecord extends org.jooq.impl.UpdatableRecordImpl<org.openforis.collect.persistence.jooq.tables.records.RecordRecord> {
	...
	private static final long serialVersionUID = 633301446;
	...
	public java.util.List<org.openforis.collect.persistence.jooq.tables.records.RecordRecord> fetchRecordList() {
		return create()
			...
			.where(org.openforis.collect.persistence.jooq.tables.Record.RECORD.SUBMITTED_ID.equal(getValue(org.openforis.collect.persistence.jooq.tables.Record.RECORD.ID)))
			.fetch();
	}
	 ...
	 * </pre></code>
	 */
	public void setSubmittedId(java.lang.Integer value) {
		setValue(org.openforis.collect.persistence.jooq.tables.Record.RECORD.SUBMITTED_ID, value);
	}
	 ...
	 * </pre></code>
	 */
	public java.lang.Integer getSubmittedId() {
		return getValue(org.openforis.collect.persistence.jooq.tables.Record.RECORD.SUBMITTED_ID);
	}
	...
	public org.openforis.collect.persistence.jooq.tables.records.RecordRecord fetchRecord() {
		return create()
			.selectFrom(org.openforis.collect.persistence.jooq.tables.Record.RECORD)
			.where(org.openforis.collect.persistence.jooq.tables.Record.RECORD.ID.equal(getValue(org.openforis.collect.persistence.jooq.tables.Record.RECORD.SUBMITTED_ID)))
			.fetchOne();
	}
