...
public class OfcRecordRecord extends org.jooq.impl.UpdatableRecordImpl<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord> {
	...
	private static final long serialVersionUID = 782820;
	...
	public java.util.List<org.openforis.collect.persistence.jooq.tables.records.OfcAttributeValueRecord> fetchOfcAttributeValueList() {
		return create()
			...
			.where(org.openforis.collect.persistence.jooq.tables.OfcAttributeValue.OFC_ATTRIBUTE_VALUE.RECORD_ID.equal(getValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.ID)))
			.fetch();
	}
	...
	public java.util.List<org.openforis.collect.persistence.jooq.tables.records.OfcEntityRecord> fetchOfcEntityList() {
		return create()
			...
			.where(org.openforis.collect.persistence.jooq.tables.OfcEntity.OFC_ENTITY.RECORD_ID.equal(getValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.ID)))
			.fetch();
	}
	...
	public java.util.List<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord> fetchOfcRecordList() {
		return create()
			...
			.where(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.SUBMITTED_ID.equal(getValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.ID)))
			.fetch();
	}
	 ...
	 * <p>
	 * <code><pre>
	 * FOREIGN KEY [collect.ofc_record.root_entity_id]
	 * REFERENCES ofc_schema_definition [collect.ofc_schema_definition.id]
	 * </pre></code>
	 */
	public void setRootEntityId(java.lang.Integer value) {
		setValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.ROOT_ENTITY_ID, value);
	}
	...
	public java.lang.Integer getRootEntityId() {
		return getValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.ROOT_ENTITY_ID);
	}
	...
	public org.openforis.collect.persistence.jooq.tables.records.OfcSchemaDefinitionRecord fetchOfcSchemaDefinition() {
		return create()
			...
			.where(org.openforis.collect.persistence.jooq.tables.OfcSchemaDefinition.OFC_SCHEMA_DEFINITION.ID.equal(getValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.ROOT_ENTITY_ID)))
			.fetchOne();
	}
	 ...
	 * <p>
	 * <code><pre>
	 * FOREIGN KEY [collect.ofc_record.submitted_id]
	 * REFERENCES ofc_record [collect.ofc_record.id]
	 * </pre></code>
	 */
	public void setSubmittedId(java.lang.Integer value) {
		setValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.SUBMITTED_ID, value);
	}
	...
	public java.lang.Integer getSubmittedId() {
		return getValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.SUBMITTED_ID);
	}
	...
	public org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord fetchOfcRecord() {
		return create()
			.selectFrom(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD)
			.where(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.ID.equal(getValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.SUBMITTED_ID)))
			.fetchOne();
	}
