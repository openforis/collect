...
public class OfcRecordRecord extends org.jooq.impl.UpdatableRecordImpl<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord> {
	...
	private static final long serialVersionUID = -2062081141;
	...
	/**
	 * The table column <code>collect.ofc_record.owner_id</code>
	 * <p>
	 * This column is part of a FOREIGN KEY: <code><pre>
	 * CONSTRAINT ofc_record__ofc_record_owner_fkey
	 * FOREIGN KEY (owner_id)
	 * REFERENCES collect.ofc_user (id)
	 * </pre></code>
	 */
	public void setOwnerId(java.lang.Integer value) {
		setValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.OWNER_ID, value);
	}
	...
	public java.lang.Integer getOwnerId() {
		return getValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.OWNER_ID);
	}
	 ...
	 * OfcUserRecord}
	 */
	public void setOwnerId(org.openforis.collect.persistence.jooq.tables.records.OfcUserRecord value) {
		if (value == null) {
			setValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.OWNER_ID, null);
		}
		else {
			setValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.OWNER_ID, value.getValue(org.openforis.collect.persistence.jooq.tables.OfcUser.OFC_USER.ID));
		}
	}
	 ...
	 * </pre></code>
	 */
	public org.openforis.collect.persistence.jooq.tables.records.OfcUserRecord fetchOfcUserByOwnerId() {
		return create()
			.selectFrom(org.openforis.collect.persistence.jooq.tables.OfcUser.OFC_USER)
			.where(org.openforis.collect.persistence.jooq.tables.OfcUser.OFC_USER.ID.equal(getValue(org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.OWNER_ID)))
			.fetchOne();
	}
