...
public class OfcDataCleansingStepRecord extends UpdatableRecordImpl<OfcDataCleansingStepRecord> implements Record7<Integer, String, Integer, String, String, Timestamp, Timestamp> {

	private static final long serialVersionUID = 1094899775;
	 ...
	 */
	@Override
	public OfcDataCleansingStepRecord values(Integer value1, String value2, Integer value3, String value4, String value5, Timestamp value6, Timestamp value7) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public OfcDataCleansingStepRecord(Integer id, String uuid, Integer queryId, String title, String description, Timestamp creationDate, Timestamp modifiedDate) {
		super(OfcDataCleansingStep.OFC_DATA_CLEANSING_STEP);
