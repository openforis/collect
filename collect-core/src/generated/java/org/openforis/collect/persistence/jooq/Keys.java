...
public class Keys extends org.jooq.impl.AbstractKeys {
	...
	public static final org.jooq.UniqueKey<org.openforis.collect.persistence.jooq.tables.records.OfcSamplingDesingRecord> ofc_sampling_desing_pkey = createUniqueKey(org.openforis.collect.persistence.jooq.tables.OfcSamplingDesing.OFC_SAMPLING_DESING, org.openforis.collect.persistence.jooq.tables.OfcSamplingDesing.OFC_SAMPLING_DESING.ID);
	...
	public static final org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.OfcSamplingDesingRecord, org.openforis.collect.persistence.jooq.tables.records.OfcSurveyRecord> ofc_sampling_desing__ofc_sampling_design_survey_fkey = createForeignKey(ofc_survey_pkey, org.openforis.collect.persistence.jooq.tables.OfcSamplingDesing.OFC_SAMPLING_DESING, org.openforis.collect.persistence.jooq.tables.OfcSamplingDesing.OFC_SAMPLING_DESING.SURVEY_ID);
	public static final org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.OfcSamplingDesingRecord, org.openforis.collect.persistence.jooq.tables.records.OfcSurveyWorkRecord> ofc_sampling_desing__ofc_sampling_design_survey_work_fkey = createForeignKey(ofc_survey_work_pkey, org.openforis.collect.persistence.jooq.tables.OfcSamplingDesing.OFC_SAMPLING_DESING, org.openforis.collect.persistence.jooq.tables.OfcSamplingDesing.OFC_SAMPLING_DESING.SURVEY_WORK_ID);
	...
	public static final org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.OfcTaxonomyRecord, org.openforis.collect.persistence.jooq.tables.records.OfcSurveyWorkRecord> ofc_taxonomy__ofc_taxonomy_survey_work_fkey = createForeignKey(ofc_survey_work_pkey, org.openforis.collect.persistence.jooq.tables.OfcTaxonomy.OFC_TAXONOMY, org.openforis.collect.persistence.jooq.tables.OfcTaxonomy.OFC_TAXONOMY.SURVEY_WORK_ID);
	public static final org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.OfcTaxonomyRecord, org.openforis.collect.persistence.jooq.tables.records.OfcSurveyRecord> ofc_taxonomy__ofc_taxonomy_survey_fkey = createForeignKey(ofc_survey_pkey, org.openforis.collect.persistence.jooq.tables.OfcTaxonomy.OFC_TAXONOMY, org.openforis.collect.persistence.jooq.tables.OfcTaxonomy.OFC_TAXONOMY.SURVEY_ID);
