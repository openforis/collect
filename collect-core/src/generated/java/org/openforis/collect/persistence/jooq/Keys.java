...
public class Keys extends org.jooq.impl.AbstractKeys {
	...
	public static final org.jooq.UniqueKey<org.openforis.collect.persistence.jooq.tables.records.OfcTaxonRecord> ofc_taxon_pkey = createUniqueKey(org.openforis.collect.persistence.jooq.tables.OfcTaxon.OFC_TAXON, org.openforis.collect.persistence.jooq.tables.OfcTaxon.OFC_TAXON.SYSTEM_ID);
	public static final org.jooq.UniqueKey<org.openforis.collect.persistence.jooq.tables.records.OfcTaxonRecord> UNIQUE_ofc_taxon_id = createUniqueKey(org.openforis.collect.persistence.jooq.tables.OfcTaxon.OFC_TAXON, org.openforis.collect.persistence.jooq.tables.OfcTaxon.OFC_TAXON.TAXON_ID, org.openforis.collect.persistence.jooq.tables.OfcTaxon.OFC_TAXON.TAXONOMY_ID);
	...
	public static final org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord, org.openforis.collect.persistence.jooq.tables.records.OfcSchemaDefinitionRecord> ofc_record__record_root_entity_definition_fkey = createForeignKey(ofc_schema_definition_pkey, org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD, org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.ROOT_ENTITY_DEFINITION_ID);
	...
	public static final org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord, org.openforis.collect.persistence.jooq.tables.records.OfcUserRecord> ofc_record__ofc_record_locked_by_user_fkey = createForeignKey(ofc_user_pkey, org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD, org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.LOCKED_BY_ID);
	public static final org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.OfcSchemaDefinitionRecord, org.openforis.collect.persistence.jooq.tables.records.OfcSurveyRecord> ofc_schema_definition__schema_definition_survey_fkey = createForeignKey(ofc_survey_pkey, org.openforis.collect.persistence.jooq.tables.OfcSchemaDefinition.OFC_SCHEMA_DEFINITION, org.openforis.collect.persistence.jooq.tables.OfcSchemaDefinition.OFC_SCHEMA_DEFINITION.SURVEY_ID);
