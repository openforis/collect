...
public class Keys extends org.jooq.impl.AbstractKeys {
	...
	public static final org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord, org.openforis.collect.persistence.jooq.tables.records.OfcSchemaDefinitionRecord> ofc_record__record_root_entity_fkey = createForeignKey(ofc_schema_definition_pkey, org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD, org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.ROOT_ENTITY_ID);
	...
	public static final org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord, org.openforis.collect.persistence.jooq.tables.records.OfcRecordRecord> ofc_record__record_submitted_record_fkey = createForeignKey(ofc_record_pkey, org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD, org.openforis.collect.persistence.jooq.tables.OfcRecord.OFC_RECORD.SUBMITTED_ID);
