...
public class Keys {
	...
	public static final UniqueKey<OfcRecordFileRecord> OFC_RECORD_FILE_PKEY = UniqueKeys0.OFC_RECORD_FILE_PKEY;
	...
	public static final ForeignKey<OfcRecordFileRecord, OfcSurveyRecord> OFC_RECORD_FILE__OFC_RECORD_FILE_SURVEY_FKEY = ForeignKeys0.OFC_RECORD_FILE__OFC_RECORD_FILE_SURVEY_FKEY;
	public static final ForeignKey<OfcRecordFileRecord, OfcRecordRecord> OFC_RECORD_FILE__OFC_RECORD_FILE_RECORD_FKEY = ForeignKeys0.OFC_RECORD_FILE__OFC_RECORD_FILE_RECORD_FKEY;
	public static final ForeignKey<OfcRecordFileRecord, OfcUserRecord> OFC_RECORD_FILE__OFC_RECORD_FILE_CREATED_BY_USER_FKEY = ForeignKeys0.OFC_RECORD_FILE__OFC_RECORD_FILE_CREATED_BY_USER_FKEY;
	public static final ForeignKey<OfcRecordFileRecord, OfcUserRecord> OFC_RECORD_FILE__OFC_RECORD_FILE_MODIFIED_BY_USER_FKEY = ForeignKeys0.OFC_RECORD_FILE__OFC_RECORD_FILE_MODIFIED_BY_USER_FKEY;
	...
	private static class UniqueKeys0 extends AbstractKeys {
		...
		public static final UniqueKey<OfcRecordFileRecord> OFC_RECORD_FILE_PKEY = createUniqueKey(OfcRecordFile.OFC_RECORD_FILE, OfcRecordFile.OFC_RECORD_FILE.UUID);
	...
	private static class ForeignKeys0 extends AbstractKeys {
		...
		public static final ForeignKey<OfcRecordFileRecord, OfcSurveyRecord> OFC_RECORD_FILE__OFC_RECORD_FILE_SURVEY_FKEY = createForeignKey(org.openforis.collect.persistence.jooq.Keys.OFC_SURVEY_PKEY, OfcRecordFile.OFC_RECORD_FILE, OfcRecordFile.OFC_RECORD_FILE.SURVEY_ID);
		public static final ForeignKey<OfcRecordFileRecord, OfcRecordRecord> OFC_RECORD_FILE__OFC_RECORD_FILE_RECORD_FKEY = createForeignKey(org.openforis.collect.persistence.jooq.Keys.OFC_RECORD_PKEY, OfcRecordFile.OFC_RECORD_FILE, OfcRecordFile.OFC_RECORD_FILE.RECORD_ID);
		public static final ForeignKey<OfcRecordFileRecord, OfcUserRecord> OFC_RECORD_FILE__OFC_RECORD_FILE_CREATED_BY_USER_FKEY = createForeignKey(org.openforis.collect.persistence.jooq.Keys.OFC_USER_PKEY, OfcRecordFile.OFC_RECORD_FILE, OfcRecordFile.OFC_RECORD_FILE.CREATED_BY_ID);
		public static final ForeignKey<OfcRecordFileRecord, OfcUserRecord> OFC_RECORD_FILE__OFC_RECORD_FILE_MODIFIED_BY_USER_FKEY = createForeignKey(org.openforis.collect.persistence.jooq.Keys.OFC_USER_PKEY, OfcRecordFile.OFC_RECORD_FILE, OfcRecordFile.OFC_RECORD_FILE.MODIFIED_BY_ID);
