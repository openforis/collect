...
public class OfcSurvey extends org.jooq.impl.UpdatableTableImpl<org.openforis.collect.persistence.jooq.tables.records.OfcSurveyRecord> {
	...
	private static final long serialVersionUID = 89104806;

	/**
	 * The singleton instance of ofc_survey
	 */
	 ...
	 */
	private static final java.lang.Class<org.openforis.collect.persistence.jooq.tables.records.OfcSurveyRecord> __RECORD_TYPE = org.openforis.collect.persistence.jooq.tables.records.OfcSurveyRecord.class;
	 ...
	 * No further instances allowed
	 */
	private OfcSurvey(java.lang.String alias) {
	...
	public java.util.List<org.jooq.UniqueKey<org.openforis.collect.persistence.jooq.tables.records.OfcSurveyRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.openforis.collect.persistence.jooq.tables.records.OfcSurveyRecord>>asList(org.openforis.collect.persistence.jooq.Keys.ofc_survey_pkey, org.openforis.collect.persistence.jooq.Keys.ofc_survey_uri_key);
	}
