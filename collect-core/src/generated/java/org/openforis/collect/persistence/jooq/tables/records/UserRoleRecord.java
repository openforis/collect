...
public class UserRoleRecord extends org.jooq.impl.UpdatableRecordImpl<org.openforis.collect.persistence.jooq.tables.records.UserRoleRecord> {
	...
	private static final long serialVersionUID = -1931851805;
	 ...
	 * </pre></code>
	 */
	public org.openforis.collect.persistence.jooq.tables.records.UserRecord fetchUser() {
		return create()
			.selectFrom(org.openforis.collect.persistence.jooq.tables.User.USER)
			.where(org.openforis.collect.persistence.jooq.tables.User.USER.ID.equal(getValue(org.openforis.collect.persistence.jooq.tables.UserRole.USER_ROLE.USER_ID)))
			.fetchOne();
	}
