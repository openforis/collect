...
public class Taxon extends org.jooq.impl.UpdatableTableImpl<org.openforis.collect.persistence.jooq.tables.records.TaxonRecord> {
	...
	private static final long serialVersionUID = -169628094;
	...
	public org.jooq.UniqueKey<org.openforis.collect.persistence.jooq.tables.records.TaxonRecord> getMainKey() {
		return org.openforis.collect.persistence.jooq.Keys.PK_taxon;
	}

	@Override
	@SuppressWarnings("unchecked")
	public java.util.List<org.jooq.UniqueKey<org.openforis.collect.persistence.jooq.tables.records.TaxonRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.openforis.collect.persistence.jooq.tables.records.TaxonRecord>>asList(org.openforis.collect.persistence.jooq.Keys.PK_taxon);
	}
	...
	public java.util.List<org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.TaxonRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.TaxonRecord, ?>>asList(org.openforis.collect.persistence.jooq.Keys.FK_taxon_taxonomy);
	}
