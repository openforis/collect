...
public class Data extends org.jooq.impl.UpdatableTableImpl<org.openforis.collect.persistence.jooq.tables.records.DataRecord> {
	...
	private static final long serialVersionUID = 1643931051;
	 ...
	 * An uncommented item
	 */
	public final org.jooq.TableField<org.openforis.collect.persistence.jooq.tables.records.DataRecord, java.math.BigDecimal> NUMBER1 = createField("number1", org.jooq.impl.SQLDataType.DECIMAL, this);

	/**
	 * An uncommented item
	 */
	public final org.jooq.TableField<org.openforis.collect.persistence.jooq.tables.records.DataRecord, java.math.BigDecimal> NUMBER2 = createField("number2", org.jooq.impl.SQLDataType.DECIMAL, this);

	/**
	 * An uncommented item
	 */
	public final org.jooq.TableField<org.openforis.collect.persistence.jooq.tables.records.DataRecord, java.math.BigDecimal> NUMBER3 = createField("number3", org.jooq.impl.SQLDataType.DECIMAL, this);
	...
	public org.jooq.UniqueKey<org.openforis.collect.persistence.jooq.tables.records.DataRecord> getMainKey() {
		return org.openforis.collect.persistence.jooq.Keys.PK_data;
	}

	@Override
	@SuppressWarnings("unchecked")
	public java.util.List<org.jooq.UniqueKey<org.openforis.collect.persistence.jooq.tables.records.DataRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.openforis.collect.persistence.jooq.tables.records.DataRecord>>asList(org.openforis.collect.persistence.jooq.Keys.PK_data);
	}

	@Override
	@SuppressWarnings("unchecked")
	public java.util.List<org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.DataRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.DataRecord, ?>>asList(org.openforis.collect.persistence.jooq.Keys.FK_data_record, org.openforis.collect.persistence.jooq.Keys.FK_data_schema_definition, org.openforis.collect.persistence.jooq.Keys.FK_data_taxon, org.openforis.collect.persistence.jooq.Keys.FK_data_parent);
	}
