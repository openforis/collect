...
public class Data extends org.jooq.impl.UpdatableTableImpl<org.openforis.collect.persistence.jooq.tables.records.DataRecord> {
	...
	private static final long serialVersionUID = -2141678210;
	...
	public java.util.List<org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.DataRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.openforis.collect.persistence.jooq.tables.records.DataRecord, ?>>asList(org.openforis.collect.persistence.jooq.Keys.data__FK_data_record, org.openforis.collect.persistence.jooq.Keys.data__FK_data_schema_definition, org.openforis.collect.persistence.jooq.Keys.data__FK_data_parent);
	}
