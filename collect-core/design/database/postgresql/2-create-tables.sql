/*
Script generated by Aqua Data Studio 10.0.4 on Jan-24-2012 12:13:11 PM
Database: null
Schema: <All Schemas>
*/

DROP VIEW "collect"."entity_count_view"
GO
...
ALTER TABLE "collect"."record"
	...
	REFERENCES "collect"."user"("id")
GO
CREATE VIEW "collect"."entity_count_view"
AS
select collect.data.record_id, collect.data.definition_id, count(collect.data.id)
from collect.data
group by collect.data.record_id, collect.data.definition_id
GO
